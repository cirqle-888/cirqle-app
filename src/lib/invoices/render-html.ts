...
export function renderInvoiceHtml(
  ...
  const thankBlock = `
    <div style="font-family:'Airbnb Cereal App',${FONT};min-height:104px;display:flex;flex-direction:column;justify-content:center;line-height:1.2;padding-left:15px">
  ...
  const waIcon = `<img src="data:image/svg+xml,${waIconSvg}" width="17" height="17" style="width:17px;height:17px;display:inline-block;position:relative;top:10px;flex-shrink:0" />`
  const globeIcon = `<img src="data:image/svg+xml,${globeIconSvg}" width="17" height="17" style="width:17px;height:17px;display:inline-block;position:relative;top:10px;flex-shrink:0" />`
